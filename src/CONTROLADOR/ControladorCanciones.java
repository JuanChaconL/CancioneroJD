 ...
 * @author Usuario
 */
public class ControladorCanciones  implements ActionListener, MouseListener{
    
    private final VentanaCanciones view;
    private final Lista model;

    public ControladorCanciones(VentanaCanciones view, Lista model) {
        this.view = view;
        this.model = model;
